  ...
  <section id="home" class="hero">
    ...
    <div class="container hero__content">
      ...
      <p class="hero__description reveal reveal-delay-3" :class="{ visible: loaded }">
        A passionate Software Developer crafting high-performance web applications
        with Vue.js, React, Java &amp; Spring Boot. Turning ideas into elegant,
    ...
    <div class="hero__socials">
      ...
      <a href="mailto:milani@example.com" class="social-link" aria-label="Email">
