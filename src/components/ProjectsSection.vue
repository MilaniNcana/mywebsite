...
const projects = [
  {
    title: 'Trogster',
    description: 'A task management system that allows organizations to create tasks, manage workers, and collect structured field data. Built with a Vue.js frontend and Spring Boot REST API backend.',
    tags: ['Vue.js', 'Spring Boot', 'Java', 'SQL'],
  ...
  {
    title: 'RentMyStuff',
    description: 'An online peer-to-peer platform to rent anything in exchange for money. Connects owners and renters with a clean, responsive interface and secure transaction flow.',
    tags: ['Vue.js', 'JavaScript', 'Bootstrap', 'SQL'],
    category: ['Full Stack', 'Vue.js'],
  ...
  },
  {
    ...
    description: 'An e-commerce website to rent cars, featuring vehicle browsing, booking management, and a full rental workflow built with Java and web technologies.',
  ...
  {
    title: 'StyleForLess',
    description: 'A peer-to-peer e-commerce platform to buy and sell high-end second-hand clothing. Features product listings, user profiles, and a seamless checkout experience.',
    tags: ['Vue.js', 'TypeScript', 'Bootstrap', 'SQL'],
    category: ['Full Stack', 'Vue.js', 'Frontend'],
