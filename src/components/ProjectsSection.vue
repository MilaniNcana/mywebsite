          ...
          >
            ...
            <div class="project-card__body">
              ...
              <div class="project-card__links">
                <a :href="project.demo" target="_blank" class="project-link project-link--demo" rel="noopener noreferrer">
...
const filters = ['All', 'Vue.js', 'Java', 'Full Stack', 'Frontend']

const projects = [
  {
    title: 'Enterprise Task Manager',
    description: 'A full-stack task management platform with real-time updates, team collaboration, JWT authentication, and a Spring Boot REST API backend.',
    tags: ['Vue.js', 'Spring Boot', 'MySQL', 'JWT'],
  ...
  },
  {
    ...
    description: 'A responsive Vue.js e-commerce frontend with cart management, product filtering, and seamless checkout flow.',
  ...
  },
  {
    ...
    description: 'A scalable REST API built with Spring Boot, featuring microservices architecture, Docker containerization, and comprehensive API documentation.',
  ...
  },
  {
    ...
    description: 'A dynamic portfolio management dashboard with data visualizations, responsive layout, and dark mode support built in Vue.js.',
    tags: ['Vue.js', 'JavaScript', 'Charts'],
    category: ['Vue.js', 'Frontend'],
  ...
  },
  {
    ...
    description: 'WebSocket-powered chat app with rooms, typing indicators, file sharing, and user authentication using Java backend.',
    tags: ['Java', 'WebSocket', 'Vue.js', 'MySQL'],
    category: ['Full Stack', 'Java', 'Vue.js'],
    gradient: 'linear-gradient(135deg, #1a140a 0%, #2e2010 50%, #3a2a0a 100%)',
    featured: false,
    demo: '#',
    github: 'https://github.com/MilaniNcana',
  },
  {
    title: 'Weather App',
    description: 'A beautiful weather application with geolocation, 7-day forecasts, animated weather icons, and city search built with React.',
    tags: ['React', 'JavaScript', 'API'],
    category: ['Frontend'],
    gradient: 'linear-gradient(135deg, #0a1020 0%, #0d1a35 50%, #0a1828 100%)',
    featured: false,
    demo: '#',
    github: 'https://github.com/MilaniNcana',
  },
